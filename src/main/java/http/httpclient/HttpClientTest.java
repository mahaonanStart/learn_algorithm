...
//        httpClient.get("https://m.mycaigou.com/api/v2/search/procurement?page=1&withinXDays=&pDateSort=1");
        FileResponseHandler handler = (FileResponseHandler) httpClient.get("http://eshopop.wanmei.com/wanmeiEshop/shopOrder/exportSearchCsv?id=&sellerId=15&productId=&orderSn=&parentOrderId=&userId=&userName=&orderType=&orderStatus=&payStatus=&consignee=&mobile=&startAddTime=&endAddTime=&startPayTime=&endPayTime=&payHistoryId=", params, headers, "utf-8");
        handler.save("/Users/mahaonan/mhn/test");
//        httpClient.get("https://www.baidu.com/s?ie=UTF-8&wd=Content-Disposition");
